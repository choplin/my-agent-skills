...
| Skill | Description |
|-------|-------------|
| `repository-context-base` | Shared placement and lifecycle model for README, documentation sites, Architecture Guides, AGENTS.md, CHANGELOG.md, conditional ADRs, Linear, and work-tagged llm-wiki knowledge |
