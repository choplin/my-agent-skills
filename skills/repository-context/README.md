...
Skills for deciding where repository work context belongs and maintaining the
shared user and developer documentation that remains with the repository.

## Skills

| Skill | Description |
|-------|-------------|
| `repository-context-base` | Shared placement and lifecycle model for README, documentation sites, Architecture Guides, AGENTS.md, CHANGELOG.md, conditional ADRs, tracker Issues, and work-tagged llm-wiki knowledge |
