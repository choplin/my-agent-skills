...
description: >-
  Drafts and optionally posts replies to the PR review comments already
  imported into a code-review session, using each item's recorded resolution
  and the companion PR ledger.
