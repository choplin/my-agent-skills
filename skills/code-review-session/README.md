...
calls [`quick-code-review`](../quick-code-review/README.md),
[`artifact-review`](../artifact-review/README.md), or a caller-selected reviewer
...
- **Different reviewer**: `code-review-session-import-ai` calls
  `quick-code-review`, `artifact-review`, or one the caller names.
...
- `code-review-session-import-ai` delegates the review itself to
  `quick-code-review`, `artifact-review`, or a caller-selected reviewer.
