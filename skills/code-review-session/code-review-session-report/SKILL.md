...
description: >-
  Produces a completion summary of a code-review session — what was resolved,
  skipped, and postponed — for a downstream consumer such as a driving
  workflow, a written report, or an issue tracker.
