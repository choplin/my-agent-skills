...
# Access work records through octa
...
relations, type, and lifecycle intent; do not groom or complete missing content.
Use a supplied lease rather than acquiring a second one. Report priority as
unapplied because octa does not store it. Re-read mutations and return
repository identity and record numbers plus any requested operation that was
not applied.
