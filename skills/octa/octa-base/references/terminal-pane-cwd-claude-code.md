...
1. Use `workflow-adapter-worktree-read` to confirm the selected worktree and resolve
   its absolute path.
...
3. Do not use `action: "remove"`; `workflow-adapter-worktree-remove` owns removal.
