...
description: >-
  Evaluates a proposed or implemented codebase structure without changing it:
  semantic ownership, module and port boundaries, dependency direction,
  transaction and resource ownership, external representations, change
  propagation, static legibility, and model-to-code traceability. Returns
  evidence-backed findings and unresolved questions.
metadata:
