...
the separately installed `document-writing-review` skill.
...
to survive its cut, that is the separately installed
`document-writing-review` skill's work — say so in the
report.
