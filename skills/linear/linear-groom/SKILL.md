...
name: linear-groom
description: >-
  Works through the current repository's Linear Backlog one issue at a time in
  priority order, walking each from Backlog to Todo interactively until
  nothing groomable remains or the user stops.
metadata:
