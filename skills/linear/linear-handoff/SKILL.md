...
- **Awaiting pre-commit review:** keep the uncommitted `impl` Issue In Progress.
  The worktree holds the prospective change; the handoff note identifies user
  approval as the next gate.
