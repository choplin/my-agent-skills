...
> Scope guard: inception solidifies the founding concept. It does **not** track project progress — once actions are concrete, hand them to a tracking workflow (e.g. `dev-workflow-kickoff`). Keep the graph about thinking, not task management.
