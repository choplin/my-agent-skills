...
| `pdf-studio-site-base` | Shared resources, delegated to by name (not invoked directly): the Cloudflare Pages library manager (`library.py`) and the shared site design system (`style.css`). |
