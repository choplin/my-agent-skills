...
Apply the `document-toolkit-fact-check` skill and follow its procedure end-to-end on
...
`document-toolkit-fact-check` skill — do not duplicate or improvise them here. If that
